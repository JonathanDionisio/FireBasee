...
//        binding.SingUpButton.setOnClickListener(v-> onBackPressed());
    ...
    private void SignUPprocessed() {
        ...
        Teachers.put(Constants.KEY_NAME, binding.enternameSU.getText().toString());
        Teachers.put(Constants.KEY_EMAIL, binding.enteremailSU.getText().toString());
        Teachers.put(Constants.KEY_PASSWORD, binding.enterpassSU.getText().toString());
        Teachers.put(Constants.KEY_IMAGE, encodedImage);
        ...
        database.collection(Constants.KEY_COLLECTION_TEACHERS)
            ...
            databaseusers.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constants.KEY_NAME, binding.enternameSU.getText().toString());
                    preferenceManager.putString(Constants.KEY_IMAGE, encodedImage);
                    Intent intentusers = new Intent(getApplicationContext(), FirstView.class);
                    intentusers.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
