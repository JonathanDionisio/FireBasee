...
import com.example.chat.Views.LearnersView;
import com.example.chat.databinding.ActivitySignInLearnersBinding;
...
public class SignInLearners extends AppCompatActivity {

    private ActivitySignInLearnersBinding binding;
    private PreferenceManager preferenceManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivitySignInLearnersBinding.inflate(getLayoutInflater());
    ...
    private void setListeners(){
        binding.CreateAccbutton.setOnClickListener(v->
                startActivity(new Intent(getApplicationContext(), SignUpLearners.class)));
...
//                        Intent intent = new Intent(getApplicationContext(), LearnersView.class);
